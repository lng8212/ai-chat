...
open class CropImageOptions : Parcelable {
    ...
    constructor() {
        ...
        aspectRatioX = 1
        aspectRatioY = 1
        borderLineThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2f, dm)
        borderLineColor = Color.argb(90, 255, 255, 255)
        borderCornerThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3f, dm)
        borderCornerOffset = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5f, dm)
        borderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16f, dm)
        borderCornerColor = Color.WHITE
        backgroundColor = Color.argb(90, 0, 0, 0)
    ...
    protected constructor(parcel: Parcel) {
        ...
        initialCropWindowRectangle = parcel.readParcelable(Rect::class.java.getClassLoader())
    ...
    companion object CREATOR : Creator<CropImageOptions> {
