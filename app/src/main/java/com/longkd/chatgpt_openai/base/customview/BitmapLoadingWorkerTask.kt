...
import java.lang.ref.WeakReference
 ...
 class BitmapLoadingWorkerTask(cropImageView: CropImageView, uri: Uri) :
    ...
    init {
        ...
        val metrics: DisplayMetrics = cropImageView.resources.displayMetrics
        val densityAdj: Double = if (metrics.density > 1) (1 / metrics.density).toDouble() else 1.0
