...
class FineTuneRequest {
     ...
     */
    var validationFile: String? = null
     ...
     * Additionally, you must specify [FineTuneRequest.classificationNClasses] for multiclass
     * classification or [FineTuneRequest.classificationPositiveClass] for binary classification.
     */
    var computeClassificationMetrics: Boolean? = null
    ...
    var classificationNClasses: Int? = null
     ...
     */
    var classificationPositiveClass: String? = null
     ...
     */
    var classificationBetas: List<Double>? = null
