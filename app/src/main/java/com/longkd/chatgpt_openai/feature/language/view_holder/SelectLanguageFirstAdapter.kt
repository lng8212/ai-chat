...
class SelectLanguageFirstAdapter(
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return parent.bindingInflate(R.layout.item_first_language)

    }

    override fun getViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<ViewDataBinding> {
        return LanguageFirstItemVH(
            createBinding(parent, viewType) as ItemFirstLanguageBinding,
            callback,
        )
    }
